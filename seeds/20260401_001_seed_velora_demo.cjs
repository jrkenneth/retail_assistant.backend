...
exports.seed = async function seed(knex) {
  ...
  const credentials = [
    ["maya.percy", "velora-demo-001", "CUST-0001", "$2y$10$HE6AVhMW4kMyp1d8Jnpz4eeIuNJmky.KZbvNoNGdzEbcR7vJBzXim"],
    ["jason.hanley", "velora-demo-002", "CUST-0002", "$2y$10$2KvF7jChBJ5tA8rR1sUjAevHI7Lo90aFSQkgnXIscbKo9o/oEHf12"],
    ["alina.fernand", "velora-demo-003", "CUST-0003", "$2y$10$C..M7mSBee5EA5vrYLLiAOt.s/MHOiTf0F5iEbejkxDzilVibSeEO"],
    ["dev.ramchurn", "velora-demo-004", "CUST-0004", "$2y$10$PjcV.R9NkQAivn5yKPYbReGtDuF3QPsy8vPgARoI6df2Vu5BbwN42"],
    ["nora.bisset", "velora-demo-005", "CUST-0005", "$2y$10$xVgX35n0.kMQkrwHPijNOeP2YN9yCJU5AFGbSAglmE65ygm5b7bHK"],
  ].map(([username, _plainTextPassword, customer_number, password_hash]) => ({
    id: randomUUID(),
  ...
  ].map(([customerNumber, orderNumber, transaction_type, points, description, created_at]) => ({
    id: randomUUID(),
